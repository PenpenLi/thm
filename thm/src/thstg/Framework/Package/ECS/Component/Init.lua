...
RigidbodyComponent = require("thstg.Framework.Package.ECS.Component.RigidbodyComponent")
...
BoxColliderComponent = require("thstg.Framework.Package.ECS.Component.Collider.BoxColliderComponent")
CircleColliderComponent = require("thstg.Framework.Package.ECS.Component.Collider.CircleColliderComponent")