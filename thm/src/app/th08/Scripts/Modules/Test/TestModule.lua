...
function M:onCreate()
    local TestTb = {
        require("Scripts.Modules.Test.UITest.UITest0"),         --测试面板
        require("Scripts.Modules.Test.UITest.UITest1"),         --动画测试
        require("Scripts.Modules.Test.UITest.UITest2"),         --所有动画测试
        require("Scripts.Modules.Test.UITest.UITest3"),         --背景测试
        require("Scripts.Modules.Test.UITest.UITest4"),         --控制测试
        require("Scripts.Modules.Test.UITest.UITest5"),         --对话框测试
        require("Scripts.Modules.Test.UITest.UITest6"),         --时间表测试
        require("Scripts.Modules.Test.UITest.UITest7"),         --特效测试
        require("Scripts.Modules.Test.UITest.UITest8"),         --图片效果测试
    }
    --事件监听
    --注册键盘事件
