...
local SelectDifficultyLayer = require("Scripts.Modules.GUI.MainUi.MainMenu.StartSelectDifficultyLayer")
local SelectRoleLayer = require("Scripts.Modules.GUI.MainUi.MainMenu.StartSelectRoleLayer")
local M = {}
