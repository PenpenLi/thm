...
local SCENARIO_FILE_PATH_PATTERN = "Scripts.Context.Game.Modules.Stage.Scenario.StageCfg_%02d"
local M = {}
function M.create(params)
    -------Model-------
    local _uiMapLayer = require("Scripts.Context.Game.Modules.Stage.View.Layer.MapLayer").create()   --地图层
    local _uiEntityLayer = require("Scripts.Context.Game.Modules.Stage.View.Layer.EntityLayer").create()   --实体层
    local _uiScoreLayer = require("Scripts.Context.Game.Modules.Stage.View.Layer.ScoreLayer").create()  --分数层
    local _uiStatusLayer = require("Scripts.Context.Game.Modules.Stage.View.Layer.StatusLayer").create() --状态层-血条,对话框,符卡技能
    --
